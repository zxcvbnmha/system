...
<body>
    ...
    <li><a href="stuqurey.jsp"> 一.个人信息查询   </a></li> 
    <li><a href="contitle.jsp"> 二.选择论文题目 </a></li>
    <li><a href="processcheck.jsp"> 三.查看选题表 </a></li>
    <li><a href="processalter.jsp"> 四.毕业进程提交</a></li>
    <li><a href="stualter.jsp"> 五.个人信息修改</a></li>
     <li><a href="insert.jsp"> 六.补全个人信息</a></li>	
