...
<body>
    ...
    <h2>学生信息查询登入</h2>
    <div>
    <form action="stuqurey1.jsp" method="post">
    ...
    <input type="submit" value="查询" onclick="window.location.href='stuqurey1.jsp"
           style="width:120px; height:35px;padding:5px 15px; border-radius:2px; border:1px solid;"/>
    <input type="reset" value="重置" onclick="window.location.href='stuqurey.jsp"
    	   style="width:120px; height:35px;padding:5px 15px; border-radius:2px; border:1px solid;"/>
