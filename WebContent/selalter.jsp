...
<body>
    ...
    %>
    <center>
    <strong>选题信息修改：</strong>
    <div>
    <hr>
    <form action="selalter1.jsp" method="post">
    ...
    <input type="submit" value="修改" onclick="window.location.href='selalter1.jsp'"
           style="width:120px; height:35px;padding:5px 15px; border-radius:2px; border:1px solid;"/>
    <input type="reset" value="重置"  onclick="window.location.href='selalter.jsp'"
           style="width:120px; height:35px;padding:5px 15px; border-radius:2px; border:1px solid;"/>
    </form>
    </div>
    </center>
