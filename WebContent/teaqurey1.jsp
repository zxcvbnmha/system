...
<body>
    ...
    <% 
    //接收学生姓名和学号
    String u=new String(request.getParameter("teaname").getBytes("ISO-8859-1"),"UTF-8"); 
    //连接数据库
    ...
    ResultSet rs=sm.executeQuery("select * from 指导教师信息表    where 姓名='"+u+"'");
    ...
    <h1>教师信息列表</h1>
    <tr><td>教师号</td><td>姓名</td><td>性别</td><td>出生日期</td><td>学历</td><td>职称</td><td>研究方向</td><td>电话</td><td>邮箱</td></tr>
    <tr>
    ...
    <input type="submit" value="返回重新查询" onclick="window.location.href='teaqurey.jsp'"
