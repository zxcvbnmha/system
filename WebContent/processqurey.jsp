...
<body>
    ...
    <div>
    <hr>
    <form action="processqurey1.jsp" method="post">
    ...
    <input type="submit" value="查询" onclick="window.location.href='processqurey1.jsp"
           style="width:120px; height:35px;padding:5px 15px; border-radius:2px; border:1px solid;"/>
    <input type="reset" value="重置" onclick="window.location.href='processqurey.jsp"
    	   style="width:120px; height:35px;padding:5px 15px; border-radius:2px; border:1px solid;"/>
